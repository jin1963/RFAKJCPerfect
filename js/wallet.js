...
import { autoSetReferrerFromURL } from './referral.js';
...
export async function connectWallet() {
  ...
  try {
    ...
    if (!stakingABI || !usdtABI || !contractAddress || !kjcAddress || !usdtAddress || !routerAddress) {
    ...
    // ✅ เรียก autoSetReferrer จาก URL ถ้ามี
    window.autoSetReferrerFromURL?.();
